  ...
  <div class="singleSong">
    ...
    <div class="content">
      <div class="audio-info">
        <div class="img">
          <img src="../../public/images/radio1.jpg" alt="" />
        </div>
        <div class="msg">
          <h5>{{ arr[0].title }}</h5>
          <p>{{ arr[0].author }}</p>
...
export default {
  data() {
    return {
      arr: [
        {
          title: "八方旅人《感傷》（Melancholy）琴笛合奏版",
          author: "琥珀琴师Louis",
          id: 2,
        },
      ],
  ...
  mounted() {
    ...
    this.audioElement.src = "../../music/audio1.mp3"; // 设置音频文件路径
  ...
  methods: {
    handleClick() {
      ...
      localStorage.setItem("isAdd2", this.isAdd);
      if (this.isAdd) {
        console.log("add");
        this.addCollect();
      } else {
  ...
  created() {
    this.isAdd = localStorage.getItem("isAdd2") == "true" ? true : false;
  },
  components: {
    tipComp,
  },
...
.singleSong::before {
  ...
  width: 100%;
  height: 100%;
  background: url("../../public/images/radio1.jpg") no-repeat;
